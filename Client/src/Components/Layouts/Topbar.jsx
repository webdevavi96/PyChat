...
function Topbar() {
  ...
  const baseItem = 'px-3 py-2 rounded-md text-sm font-medium transition-all duration-200';
  ...
  return (
    <header className="bg-bg-soft border-border border-b px-4 py-3">
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        {/* Logo */}
        <NavLink to="/home" className="text-text-primary text-lg font-bold tracking-wide">
          PyChat
        </NavLink>
