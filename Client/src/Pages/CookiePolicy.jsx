      ...
      <div className="space-y-6">
        <Card title="1. What Are Cookies?">
          <p className="text-text-secondary">
            ...
            websites function properly, remember preferences, and improve user experience.
          </p>
        </Card>
        ...
        <Card title="3. Types of Cookies We Use">
          <ul className="text-text-secondary list-inside list-disc space-y-2">
            ...
            <li>
              <strong>Preference Cookies:</strong> Store user settings like theme or language
              preferences.
            </li>
            <li>
              <strong>Analytics Cookies:</strong> Help us understand how users interact with PyChat
        ...
        <Card title="4. Third-Party Cookies">
          <p className="text-text-secondary">
            PyChat may use trusted third-party services for analytics or performance monitoring.
            These services may set their own cookies in accordance with their respective privacy
            policies.
          </p>
        </Card>
        ...
        <Card title="5. Managing Cookies">
          <p className="text-text-secondary">
            ...
            disabling essential cookies may affect the functionality of PyChat.
          </p>
        </Card>
        ...
        <Card title="6. Updates to This Policy">
          <p className="text-text-secondary">
            ...
            page, and continued use of PyChat indicates acceptance of the updated policy.
          </p>
        </Card>
