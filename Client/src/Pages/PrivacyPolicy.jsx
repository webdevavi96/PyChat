        ...
        <div className="max-w-5xl mx-auto px-4 py-10 text-text-primary">
            ...
            <div className="mb-8">
                ...
                <p className="text-text-secondary">
                    Your privacy matters to us. This policy explains how PyChat collects,
            ...
            <div className="space-y-6">
                ...
                <Card title="1. Information We Collect">
                    <p>
                        ...
                        PyChat services. This may include:
                    </p>
                    <ul className="list-disc list-inside mt-3 space-y-1 text-text-secondary">
                ...
                <Card title="3. End-to-End Encryption">
                    <p className="text-text-secondary">
                        PyChat uses end-to-end encryption to protect your messages. This
                        means only you and the intended recipient can read the content of
                        your conversations. PyChat does not access or store readable
                        message content.
                    </p>
                </Card>
                ...
                <Card title="4. Data Sharing">
                    <p className="text-text-secondary">
                        We do not sell, trade, or rent your personal data. Information is
                        shared only when required by law or to protect the safety and
                        security of our users and platform.
                    </p>
                </Card>
                ...
                <Card title="7. Changes to This Policy">
                    <p className="text-text-secondary">
                        PyChat may update this Privacy Policy from time to time. Any changes
                        will be reflected on this page, and continued use of the platform
